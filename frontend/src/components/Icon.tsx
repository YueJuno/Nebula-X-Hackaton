...
type IconName = "train" | "plus" | "route" | "clock" | "upload" | "download" | "arrow" | "close" | "menu" | "user";
const paths: Record<IconName, ReactNode> = {
  ...
  download: <><path d="M12 4v12m-4-4 4 4 4-4M4 15v4a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-4" /></>,
